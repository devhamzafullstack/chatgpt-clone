    ...
    <div className="min-h-screen bg-black text-white p-4 flex flex-col justify-between w-full overflow-hidden">
      ...
      <div className="flex flex-col flex-grow z-10">
        <nav className="flex justify-between items-center mb-4 md:mb-8">
          <Link to="/" className="text-xl sm:text-2xl font-bold bg-gradient-to-r from-purple-500 to-indigo-500 bg-clip-text text-transparent p-2 rounded-2xl border-b border-white">
            Next AI
          </Link>
        </nav>
        ...
        <div className="flex flex-col items-center justify-center flex-grow text-center space-y-12 sm:space-y-8">
          <div className="bg-white p-6 md:p-8 rounded-xl shadow-lg max-w-md w-full space-y-6">
            ...
            <div className="flex justify-center">
              <SignUpButton className="bg-gradient-to-r from-purple-600 to-indigo-600 px-8 py-4 rounded-xl text-sm sm:text-base font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-purple-600/20 text-white">
                Sign Up with Clerk
              </SignUpButton>
            </div>
            ...
            <p className="text-gray-600 text-sm">
              Have an account?{" "}
              <Link to="/signin" className="text-purple-500 hover:text-indigo-500 transition-colors">
                Sign in here
              </Link>
            </p>
          </div>
